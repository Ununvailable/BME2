    ...
    with open("Angle_Three_sensor.csv", "a") as f:
        ...
        while True:
            ...
            def update(i):
                ...
                dir_shift4 = np.array([float(data[11]) - error4[0], float(data[10]) - error4[1], float(data[9]) - error4[2]])
                dir_shift5 = np.array([float(data[14]) - error5[0], float(data[13]) - error5[1], float(data[12]) - error5[2]])
